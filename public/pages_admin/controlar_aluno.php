    ...
    try {
        ...
        if ($_POST['action'] === 'edit_user') {
            ...
            if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
                ...
                $uploadDir = '/opt/lampp/htdocs/C.I.R.C.U.I.T.O/public/uploads/fotos_perfil/';
                ...
                /* apaga foto antiga se diferente */
                if (in_array('foto_perfil', $userCols, true)) {
                    ...
                    if ($fotoAntiga && $fotoAntiga !== 'uploads/fotos_perfil/' . $filename) {
                        $oldPath = '/opt/lampp/htdocs/C.I.R.C.U.I.T.O/public/' . ltrim($fotoAntiga, '/');
                ...
                $novaFoto = 'uploads/fotos_perfil/' . $filename;
            }
...
try {
    ...
    foreach (['matricula', 'email', 'turma', 'descricao'] as $col) {
