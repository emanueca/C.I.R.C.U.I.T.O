    ...
    try {
        ...
        if ($action === 'cadastrar') {
            ...
            if (empty($erros)) {
                ...
                header('Location: ./categoria_itens.php?cadastro=ok');
                exit;
            }
        ...
        /* ── Editar categoria existente ── */
            ...
            header('Location: ./categoria_itens.php?editado=ok');
            exit;
        ...
        /* ── Excluir categoria ── */
            ...
            if ($id_cat > 0) {
                ...
                if ($total_itens > 0) {
                    header('Location: ./categoria_itens.php?erro=vinculada&n=' . $total_itens);
                    exit;
                }

                $pdo->prepare('DELETE FROM Categoria WHERE id_cat = :id')->execute(['id' => $id_cat]);
            }
            header('Location: ./categoria_itens.php?excluido=ok');
            exit;
        }
...
<div class="modal-overlay" id="modalEditar" role="dialog" aria-modal="true" aria-labelledby="modalEditarTitulo">
    <div class="modal-box">
        ...
        <form method="POST" action="./categoria_itens.php" id="formEditar">
...
<main class="main">
    ...
    <form method="POST" action="./categoria_itens.php" id="formCadastro" novalidate>
    ...
    <div class="cat-list">
        ...
        <div class="cat-card">
            ...
            <div class="cat-actions">
                ...
                <!-- Excluir -->
                <form method="POST" action="./categoria_itens.php"
